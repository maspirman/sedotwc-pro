@extends('admin.layout', [
    ...
    'subtitle' => 'Buat halaman statis baru untuk website'
])
                ...
                <form action="{{ route('admin.cms.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('template') is-invalid @enderror"
                                ...
                                @foreach($templates as $template)
                                    <option value="{{ $template['key'] }}" {{ old('template') == $template['key'] ? 'selected' : '' }}>
                                        {{ $template['name'] }}
                        ...
                        <div id="default-template" class="col-md-12 mb-4 template-content" data-template="default">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror"
                                      ...
                                      placeholder="Tulis isi halaman di sini..." required>{{ old('content') }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="contact-hero-title" name="contact[hero_title]"
                                           value="{{ old('contact.hero_title') }}" placeholder="Hubungi Kami">
                                </div>
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="contact-hero-description" name="contact[hero_description]" rows="3"
                                              placeholder="Kami siap membantu Anda">{{ old('contact.hero_description') }}</textarea>
                                </div>
                                <div class="col-md-12 mb-4">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="contact-phone" name="contact[phone]"
                                           value="{{ old('contact.phone') }}" placeholder="+62 xxx xxxx xxxx">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="contact-email" class="form-label">Email</label>
                                    <input type="email" class="form-control" id="contact-email" name="contact[email]"
                                           value="{{ old('contact.email') }}" placeholder="contact@example.com">
                                </div>
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="contact-address" name="contact[address]" rows="3"
                                              placeholder="Jl. Contoh No. 123, Kota, Provinsi">{{ old('contact.address') }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="about-hero-title" name="about[hero_title]"
                                           value="{{ old('about.hero_title') }}" placeholder="Tentang Kami">
                                </div>
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="about-hero-description" name="about[hero_description]" rows="3"
                                              placeholder="Cerita perusahaan kami...">{{ old('about.hero_description') }}</textarea>
                                </div>
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control richtext-editor" id="about-company-story" name="about[company_story]" rows="5"
                                              placeholder="Jelaskan sejarah dan visi perusahaan">{{ old('about.company_story') }}</textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="terms-introduction" name="terms[introduction]" rows="3"
                                              placeholder="Pendahuluan syarat dan ketentuan">{{ old('terms.introduction') }}</textarea>
                                </div>
                                <div class="col-md-12 mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="privacy-effective-date" name="privacy[effective_date]"
                                           value="{{ old('privacy.effective_date') }}">
                                </div>
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="privacy-introduction" name="privacy[introduction]" rows="3"
                                              placeholder="Pendahuluan kebijakan privasi">{{ old('privacy.introduction') }}</textarea>
                                </div>
                                <div class="col-md-12 mb-4">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle me-1"></i>Simpan Halaman
                        </button>
                    </div>
                </form>
            </div>
...
$(document).ready(function() {
    console.log('jQuery ready, initializing CMS components...');
    ...
    const currentTemplate = $('#template').val();
    if (currentTemplate) {
