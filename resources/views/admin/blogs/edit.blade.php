@extends('admin.layout', [
    ...
    'subtitle' => 'Edit artikel blog "' . $blog->title . '"'
])
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror"
                                ...
                                <option value="draft" {{ old('status', $blog->status) == 'draft' ? 'selected' : '' }}>Draft (Simpan sebagai Draf)</option>
                                <option value="published" {{ old('status', $blog->status) == 'published' ? 'selected' : '' }}>Published (Terbitkan)</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="image-selection-container">
                                ...
                                <div id="currentImagePreview" class="mb-3">
                                    <div class="d-flex align-items-center gap-3 p-3 border rounded bg-light">
                                        <img src="{{ asset('storage/' . $blog->featured_image) }}" alt="{{ $blog->title }}" style="max-width: 100px; max-height: 100px; object-fit: cover;" class="rounded">
                                        <div class="flex-grow-1">
                                            <p class="mb-1 fw-bold">Gambar Saat Ini</p>
                                            <small class="text-muted">{{ $blog->featured_image }}</small>
                                        </div>
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror"
                                      ...
                                      placeholder="Tulis isi artikel di sini..." required>{{ old('content', $blog->content) }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control @error('meta_description') is-invalid @enderror"
                                      ...
                                      placeholder="Deskripsi untuk SEO" maxlength="160">{{ old('meta_description', $blog->meta_description) }}</textarea>
